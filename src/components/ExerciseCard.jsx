...
export default function ExerciseCard(props) {
    ...
    // Inside this function, the setSetsCompleted function is called to update the value of setsCompleted. setsCompleted + 1 increments the current state by 1. % 6 ensures that only 5 sets can be completed before being set back to 0.
